...
import com.mobnetic.newtonstimer.timer.NewtonsTimerViewModel.Companion.MAX_DURATION_MILLIS
...
sealed class TimerState(val durationMillis: Long) {
    ...
    protected companion object {
        fun durationToAngle(durationMillis: Long) =
            durationMillis / MAX_DURATION_MILLIS.toFloat() * MAX_ANGLE
...
fun Paused.resumed() =
    Running(durationMillis = durationMillis, alreadyElapsedMillis = elapsedMillis)
